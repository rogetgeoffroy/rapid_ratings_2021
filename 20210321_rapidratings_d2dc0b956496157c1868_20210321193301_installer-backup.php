...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210321_rapidratings_d2dc0b956496157c1868_20210321193301_archive.zip';
	const ARCHIVE_SIZE		 = '26661289';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd2dc0b9-21193301';
    const SECONDARY_PACKAGE_HASH = '2e5d0a9-21193301';
	const VERSION			 = '1.4.0';
