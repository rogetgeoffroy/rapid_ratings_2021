<div class="container marketing enterprise-solutions">
...
<?php if (has_post_thumbnail( $post->ID ) ): ?>  
  ...
  <div class="carousel-inner" style="background-image: url('<?php echo $image[0]; ?>')">
      ...
      <div class="col-sm-6 rate-suppliers-banner-text">
        <h1><?php the_field('enterprise_solutions_banner_header'); ?></h1>
        <p><?php the_field('enterprise_solutions_banner_subtitle'); ?></p>
      </div>
    </div>
      </div>
  </div>
<?php endif; ?>
  ...
  <div class="row featurette rs-section">
    <?php if( have_rows('enterprise_solutions_thumbnail_row_right_3')): ?>
      <?php while( have_rows('enterprise_solutions_thumbnail_row_right_3')): the_row();
    ...
    <?php if( have_rows('enterprise_solutions_thumbnail_row_left_1') ): ?>
      <?php while( have_rows('enterprise_solutions_thumbnail_row_left_1') ): the_row();
  ...
  <div class="row featurette rs-section">
    <?php if( have_rows('enterprise_solutions_thumbnail_row_right_1')): ?>
      <?php while( have_rows('enterprise_solutions_thumbnail_row_right_1')): the_row();
  ...
  <div class="row featurette rs-section">
  <?php if( have_rows('enterprise_solutions_thumbnail_row_left_2') ): ?>
      <?php while( have_rows('enterprise_solutions_thumbnail_row_left_2') ): the_row();
  ...
  <div class="row featurette rs-section">
    <?php if( have_rows('enterprise_solutions_thumbnail_row_right_2')): ?>
      <?php while( have_rows('enterprise_solutions_thumbnail_row_right_2')): the_row();
  ...
  <div class="row featurette rs-section">
  <?php if( have_rows('enterprise_solutions_thumbnail_row_left_3') ): ?>
      <?php while( have_rows('enterprise_solutions_thumbnail_row_left_3') ): the_row();
